...
export default function PrismaticBurst({
  ...
  useEffect(() => {
    ...
    // Canvas + GL context are created once; uniforms update in the effect below.
  ...
  useEffect(() => {
    ...
    const animTypeMap = { rotate: 0, rotate3d: 1, hover: 2 } as const
  ...
  }, [intensity, speed, animationType, paletteKey, distort, offset, rayCount])

  return <div className="prismatic-burst-container" ref={containerRef} aria-hidden />
}
